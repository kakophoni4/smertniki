...
DEXTER_NAG_LINES = (
    ...
    "Декстер, бля, тикет воняет уже {age_html}. Проветрить можно только делом",
    "Декстер, хватит ебаться с отмазками — {age_html}. Закрой нахуй и спи спокойно",
    "Декстер, ты серьёзно? {age_html} просрано. Шевелись, долбоёб",
    "Декстер, недостоверка тебя на хую вертела {age_html}. Покажи ей кузькину мать",
    "Декстер, сука, глаза разуй: {age_html}. Или тикет сам себя вылечит, гений?",
    "Декстер, пиздюлей виртуальных мало? Вот тебе ещё: {age_html} без прогресса",
    "Декстер, хватит сидеть как мешок с говном — {age_html}. Иди работай",
    "Декстер, тикет орёт громче твоей мамки: {age_html}. Заткни его «вылечено»",
    "Декстер, ебись ты с этой недостоверкой уже {age_html} — добей уже",
    "Декстер, блядь, снова ты и снова тикет. Возраст: {age_html}. Двигай",
    "Декстер, хуй тебе, а не «потом»: прошло {age_html}. Сейчас",
    "Декстер, засранец, календарь красный: {age_html}. Разгребай пиздец",
    "Декстер, тикет как геморрой — {age_html} и не проходит. Вырежи проблему",
    "Декстер, очнись, уёбище: висит {age_html}. Хватит дрыхнуть",
    "Декстер, нахуй твой «увидел» — нужно «сделал». Тикету уже {age_html}",
    "Декстер, ФНС ебёт нервы уже {age_html}. Ответь делом, не статусом",
    "Декстер, хватит дрочить прокрастинацию — {age_html}. Закрой хуйню",
    "Декстер, ты тикет растишь как кактус: {age_html}. Полей его работой",
    "Декстер, блядина конченая, {age_html} тишины. Пора орнуть прогрессом",
    "Декстер, пиздец тебе в понедельник: {age_html}. Иди сука чини",
    "Декстер, хватит прятаться за кофе — тикету {age_html}. Встал и сделал",
    "Декстер, это уже не тикет, это ебаный памятник лени: {age_html}",
    "Декстер, сука, цифры не врут: {age_html}. Хватит пиздеть — закрывай",
    "Декстер, недостоверка тебя переживёт, если так дальше. Уже {age_html}",
    "Декстер, хватит смотреть на тикет как на порно — {age_html}. Трогай руками",
    "Декстер, блядь, я заебался писать одно и то же: {age_html}. Сделай уже",
    "Декстер, твой «потом» сдохло {age_html} назад. Сейчас нахуй",
    "Декстер, пидор ленивый, тикет воняет {age_html}. Убери запах делом",
    "Декстер, хватит кормить нас обещаниями — жрём факты: {age_html}",
    "Декстер, ау, еблан: {age_html} и тикет жив. Убей его",
    "Декстер, жопой чую, ты опять забил. Подтверждение: {age_html}",
    "Декстер, нахуй паузу — пауза длится {age_html}. Play на работу",
    "Декстер, сука ты деревянная, тикет не рассосётся сам за {age_html}",
    "Декстер, хватит ебать смену — висит {age_html}. Закрой и молчи красиво",
    "Декстер, бля, даже бот в бешенстве: {age_html}. Исправь пиздец",
    "Декстер, тикет как долг коллектору: {age_html}. Плати делом",
    "Декстер, хватит сидеть в ахуе — встань в ахуе полезном. Возраст: {age_html}",
    "Декстер, уёбок милый, {age_html} без апдейта. Пора апдейтнуть жопу",
    "Декстер, пиздани себе по щекам и иди чини: прошло {age_html}",
    "Декстер, хватит нюхать цветочки — нюхай дедлайн: {age_html}",
    "Декстер, сука, тикет старше твоего настроения: {age_html}. Лечи оба",
    "Декстер, блядь, не делай вид что не видишь — {age_html} на экране",
    "Декстер, хватит быть декорацией в чате — будь палачом тикета. {age_html}",
    "Декстер, ебаный будильник: {age_html}. Встал — сделал — отписал",
    "Декстер, тикет гниёт громче твоих оправданий: {age_html}",
    "Декстер, нахуй дипломатию: {age_html}. Иди сука закрывай",
    "Декстер, хватит кормить тикет лайками «увидел» — ему нужно мясо работы. {age_html}",
    "Декстер, пидорас продуктивности ноль: {age_html}. Исправь статистику",
    "Декстер, блядина, ФНС не ждёт твоего вдохновения. Уже {age_html}",
    "Декстер, хватит ебаться с воздухом — ебись с адресом/ДЛ. Висит {age_html}",
    "Декстер, сука, тикет как борода: {age_html} без бритья. Побрей «вылечено»",
    "Декстер, очнись нахуй окончательно: {age_html}. Последнее китайское",
    "Декстер, хватит ждать чуда — чудо не придёт. Придёт пинг. Уже {age_html}",
    "Декстер, блядь, ты тикет законсервировал: {age_html}. Открой и убей",
    "Декстер, жопа зовёт к подвигу: {age_html}. Соверши уже хоть один",
    "Декстер, хуйло офисное, {age_html} тишины. Разъёбывай недостоверку",
    "Декстер, хватит прятать голову в песок — там тоже тикет. {age_html}",
    "Декстер, сука, даже песок стыдится твоей лени: {age_html}",
    "Декстер, пиздец-напоминалка №999: прошло {age_html}. Двигай",
    "Декстер, нахуй релакс — релакс после «вылечено». Сейчас {age_html}",
    "Декстер, бля, тикет как зомби: {age_html} и не дохнет. Добей",
    "Декстер, хватит кормить зомби вниманием — корми его работой. {age_html}",
    "Декстер, уёбок, цифры жмут: {age_html}. Сожми жопу и сделай",
    "Декстер, ебись ты с этим ЕГРЮЛ уже, надоело ждать: {age_html}",
    "Декстер, сука ленивая космического масштаба — тикету {age_html}",
    "Декстер, хватит быть памятником бездействию: {age_html}. Оживи жопу",
    "Декстер, блядь, weekly kick усилился: {age_html}. Почувствуй",
    "Декстер, тикет тебе в карму записан на {age_html}. Исправь карму",
    "Декстер, нахуй твой дзен — у нас тут пиздец на {age_html}",
    "Декстер, хватит медитировать на кнопку «тикеты» — жми «вылечить». {age_html}",
    "Декстер, пидор, вставай: {age_html} это уже не шутка, это диагноз",
    "Декстер, сука, диагноз простой — лень. Лечение: закрыть тикет за {age_html}",
    "Декстер, блядина, хватит лечить чат мемами — лечи недостоверку. {age_html}",
    "Декстер, ау нахуй громко: {age_html}. Ответь делом, не стикером",
    "Декстер, хватит слать сердечки тикету — пошли ему смерть. Возраст {age_html}",
    "Декстер, ебаный цирк: клоун ты, тикет в центре. Идёт уже {age_html}",
    "Декстер, закрой цирк нахуй — закрой тикет. Прошло {age_html}",
    "Декстер, сука, последний пинок на сегодня: {age_html}. Сделай или стыдно будет",
)
